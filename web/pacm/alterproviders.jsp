...
<%		
		...
		String peename = request.getParameter("peename");
//		if(peename!=null){
//    		 peename=new String(peename.getBytes("ISO8859_1"),"utf-8");
//		}
		...
		<div margin: 0 auto >
			<div class="panel panel-default" >
			  <div class="panel-heading" >
			  	<div class="row" >
			    <h3  style="text-align:center;"><a href="<%=basePath%>providerall">供应商列表 </a></h3>
			    <br/>
			  	</div>
			  </div>
			  <div class="panel-body" id="showdiv" style="text-align:center;">
			   <form action="<%=basePath%>updprovider" method="post" class="col-md-5" onSubmit="return test_();" >
			   <input type="hidden" name="peeid" value=<%=peeid %> >
			    供应商名称：<input type="text" name="peename" value=<%=peename %> style="border-radius:5px;" >
			    <br/>
			 
			      <br/>
			        <br/>
			  	电话：<input type="text" name="telephone" id="mytest" value=<%=telephone %> style="border-radius:5px;"> 
			  	 <br/>
			 
			      <br/>
			        <br/>
			        地址：<input type="text" name="address" value=<%=address %> style="border-radius:5px;"> 
			  	<br/>
			  	<br/>
