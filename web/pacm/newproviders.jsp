		...
		<div margin: 0 auto >
			<div class="panel panel-default" >
			  ...
			  <div class="panel-body" id="showdiv" style="text-align:center;">
			   <form action="<%=basePath%>addprovider" method="post" class="col-md-5" onSubmit="return test_();" style="text-align:center;">
			    供应商名称：<input type="text" name="peename" style="border-radius:5px;">
			    <br/>
			    <br/>
			    <br/>
			  	电话：<input type="text" name="telephone" id="mytest" style="border-radius:5px;"> 
			  		 <br/>
			      <br/>
			        <br/>
			        地址：<input type="text" name="address" style="border-radius:5px;">
			  	<br/>
			  	<br/>
