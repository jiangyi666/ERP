...
@WebServlet(name = "getAllMaterrielStorageDetailServlet",urlPatterns = "/getAllMaterrielStorageDetail.do")
public class getAllMaterrielStorageDetailServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<MaterrielStorageDetail> materrielStorageDetails = service.getAllMaterrielStorageDetail();
