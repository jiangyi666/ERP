...
@WebServlet(name = "getMSDByMatIdServlet",urlPatterns = "/getMSDByMatId.do")
public class getMSDByMatIdServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<MaterrielStorageDetail> materrielStorageDetails = service.getSingleMDSByMatId(matId);
        
        for (MaterrielStorageDetail materrielStorageDetail : materrielStorageDetails) {
			System.out.println(materrielStorageDetail);
		}
