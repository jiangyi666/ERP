...
@WebServlet(name = "getMSDByGoodLocServlet",urlPatterns = "/getMSDByGoodLoc.do")
public class getMSDByGoodLocServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<MaterrielStorageDetail> materrielStorageDetails = service.getMSDByGoodLoc(location);
