...
@WebServlet(name = "getAllProductStorageDetailServlet",urlPatterns = "/getAllProductStorageDetail.do")
public class getAllProductStorageDetailServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<ProductStorageDetail> productStorageDetails= productStorageDetailServiceImpl.getAllProductStorageDetail();
