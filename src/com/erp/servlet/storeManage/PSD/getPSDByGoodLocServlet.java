...
@WebServlet(name = "getPSDByGoodLocServlet",urlPatterns = "/getPSDByGoodLoc.do")
public class getPSDByGoodLocServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<ProductStorageDetail> productStorageDetails = productStorageDetailServiceImpl.getPSDByGoodLoc(location);
