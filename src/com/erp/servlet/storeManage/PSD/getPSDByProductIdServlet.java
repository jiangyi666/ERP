...
@WebServlet(name = "getPSDByProductIdServlet",urlPatterns = "/getPSDByProductId.do")
public class getPSDByProductIdServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<ProductStorageDetail> productStorageDetails = productStorageDetailServiceImpl.getSinglePSDByProId(productId);
